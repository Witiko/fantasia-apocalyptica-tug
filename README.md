...
```
latexmk -pdf tb145starynovotny-fantasia.ltx
```

After running the command, a file [`tb145starynovotny-fantasia.pdf`][1] with
the typeset article will be created.

 [1]: https://github.com/witiko/fantasia-apocalyptica-tug/releases/download/latest/tb145starynovotny-fantasia.pdf
